...
function Home({ status, error, rememberedUsername, signIn }: HomeProps) {
  return (
    <div className="flex flex-1 flex-col">
      <main className="flex flex-1 items-center justify-center px-6 py-10">
        <div className="w-full max-w-md border border-white/10">
          <div className="flex flex-col items-center gap-4 px-10 py-14">
            ...
            <Heading as="h1" font="mono" size="3xl" weight="medium" animate={false} className="text-white">
              Observer
            </Heading>
      ...
      <footer className="border-t border-white/10 px-6 py-3 text-center">
        <p className="font-label text-2xs text-white/40 font-mono">
          Developed with <span className="text-red-500 animate-pulse">❤️</span> by{' '}
          <a
            href="https://github.com/whoisleoo"
            className="text-white/60 underline decoration-white/20 underline-offset-2 transition-colors hover:text-white font-mono"
          >
            whoisleoo
          </a>
        </p>
